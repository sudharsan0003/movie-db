  ...
  return (
    <div>
      <div className='w-full text-center flex flex-col items-center justify-center '>
        <div className=' p-2 mb-1 justify-between sm:flex sm:items-center sm:justify-between bg-slate-400 w-10/12  h-32 px-36'>
          <div>
            <img
          ...
          <div className='flex flex-row gap-10 mt-10  px-36'>
            <Link to='/about'>
              <p>About</p>
            </Link>
            <Link to='/about'>
